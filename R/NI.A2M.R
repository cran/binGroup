...
#' @title Non-informative array testing with master pooling
#'
#' @author Brianna Hitt
#'
...
#' array testing with master pooling. Array testing with master
#' pooling involves testing all specimens in the array together in one group
#' before any row or column groups are formed. This function uses only
#' square arrays, which is the way array-based group testing is carried out
#' in most real-world applications. See Hitt et al. (2018) at
#' \url{http://www.chrisbilder.com/grouptesting/HBTM/} or Kim et al.
...
#' #   testing with master pooling over a range of group (row/column) sizes
...
#' #   (row/column) size for non-informative array testing with
#' #   master pooling
#' NI.A2M(p=rep(0.01,8), Se=0.90, Sp=0.90, group.sz=8,
#' obj.fn=c("ET", "MAR", "GR"),
...
NI.A2M <- function(p, Se, Sp, group.sz, obj.fn, weights){
